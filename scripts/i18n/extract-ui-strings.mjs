...
const EXTRA_UI_FILES = [
  path.join(PROJECT_ROOT, 'src/scripts/agent/agent-configuration-service.js'),
  path.join(PROJECT_ROOT, 'src/scripts/agent/agent-reference-context.js'),
  path.join(PROJECT_ROOT, 'src/scripts/agent/custom-agent-request-runtime.js'),
  path.join(PROJECT_ROOT, 'src/scripts/agent/custom-agent-tool-catalog.js'),
  path.join(PROJECT_ROOT, 'src/scripts/agent/input-agent-runtime.js'),
  path.join(PROJECT_ROOT, 'src/scripts/agent/agent-invocation.js'),
  path.join(PROJECT_ROOT, 'src/scripts/storage/agent-config-store.js'),
  path.join(PROJECT_ROOT, 'src/scripts/agent/agent-text-target.js'),
  path.join(PROJECT_ROOT, 'src/scripts/agent/agent-rendered-target.js'),
  path.join(PROJECT_ROOT, 'src/scripts/agent/text-edit-runtime.js'),
  path.join(PROJECT_ROOT, 'src/scripts/agent/agent-request-builder.js'),
...
const FULL_UI_DEFINITION_FILES = new Set([
  ...
  path.join(UI_ROOT, 'chat/agent-reference-app-runtime.js'),
  path.join(UI_ROOT, 'chat/custom-agent-app-runtime.js'),
  path.join(UI_ROOT, 'chat/chat-image-job-runtime.js'),
  path.join(PROJECT_ROOT, 'src/scripts/agent/agent-reference-context.js'),
  path.join(PROJECT_ROOT, 'src/scripts/agent/custom-agent-request-runtime.js'),
  path.join(PROJECT_ROOT, 'src/scripts/agent/custom-agent-tool-catalog.js'),
  path.join(UI_ROOT, 'chat/agent-rendered-body.js'),
  path.join(UI_ROOT, 'agent-toolbox.js'),
  path.join(PROJECT_ROOT, 'src/scripts/agent/agent-request-builder.js'),
  path.join(PROJECT_ROOT, 'src/scripts/agent/agent-configuration-service.js'),
  path.join(PROJECT_ROOT, 'src/scripts/agent/input-agent-runtime.js'),
  path.join(PROJECT_ROOT, 'src/scripts/agent/agent-invocation.js'),
