export const installAgentRequestPreviewStyle = doc => {
  ...
  .prompt-diff-add.is-partial{background:rgba(var(--app-diff-add-rgb,var(--app-success-rgb,46,160,67)),.06)}.prompt-diff-del.is-partial{text-decoration:none;opacity:1;background:rgba(var(--app-diff-del-rgb,var(--app-danger-rgb,248,81,73)),.05)}
  .prompt-diff-add .wd-ins,.prompt-diff-del .wd-del{color:inherit;text-decoration:none;border-radius:3px;box-decoration-break:clone}.prompt-diff-add .wd-ins{background:rgba(var(--app-diff-add-rgb,var(--app-success-rgb,46,160,67)),.26)}.prompt-diff-del .wd-del{text-decoration:line-through;background:rgba(var(--app-diff-del-rgb,var(--app-danger-rgb,248,81,73)),.24)}
